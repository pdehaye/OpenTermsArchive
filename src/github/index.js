...
const GITHUB_VERSIONS_URL = 'https://github.com/OpenTermsArchive/versions-dating/blob/main';
const GITHUB_REPO_URL = `https://github.com/${process.env.GITHUB_REPO}/blob/main/declarations`;
